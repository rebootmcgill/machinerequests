...
def generate_receipt(request, pk):
    ...
    p.line(350, 700, 600, 700)
    p.drawString(360, 703, str(machine.request.faculty_and_dept))
    ...
    p.rect(120, 650, 20, 20)
    if(machine.request.need_display):
        p.line(120, 650, 140, 670)
        p.line(140, 650, 120, 670)
    p.drawString(200, 630, 'MOUSE:')
    p.rect(220, 650, 20, 20)
    if(machine.request.need_mouse):
        p.line(220, 650, 240, 670)
        p.line(240, 650, 220, 670)
    p.drawString(300, 630, 'KEYBOARD:')
    p.rect(320, 650, 20, 20)
    if(machine.request.need_keyboard):
        p.line(320, 650, 340, 670)
        p.line(340, 650, 320, 670)
    p.drawString(400, 630, 'ETHERNET:')
    p.rect(420, 650, 20, 20)
    if(machine.request.need_ethernet):
        p.line(420, 650, 440, 670)
        p.line(440, 650, 420, 670)
    ...
    p.line(120, 572, 230, 547)
    p.drawString(180, 550, str(machine.cpu))
    p.drawString(230, 550, 'RAM:')
    p.line(320, 572, 430, 547)
    p.drawString(380, 550, str(machine.ram_human()))
    p.drawString(430, 550, 'HHD:')
    p.line(520, 572, 630, 547)
    p.drawString(580, 550, str(machine.hdd_human()))
