...
def generate_receipt(request, pk):
    ...
    p.rect(160, 620, 20, 20)
    if(machine.request.need_display):
        p.line(160, 620, 180, 640)
        p.line(180, 620, 160, 640)
    p.drawString(200, 630, 'MOUSE:')
    p.rect(260, 620, 20, 20)
    if(machine.request.need_mouse):
        p.line(260, 620, 280, 640)
        p.line(280, 620, 260, 640)
    p.drawString(300, 630, 'KEYBOARD:')
    p.rect(360, 620, 20, 20)
    if(machine.request.need_keyboard):
        p.line(360, 620, 380, 640)
        p.line(380, 620, 360, 640)
    p.drawString(400, 630, 'ETHERNET:')
    p.rect(460, 620, 20, 20)
    if(machine.request.need_ethernet):
        p.line(460, 620, 480, 640)
        p.line(480, 620, 460, 640)
