...
class RequestAdmin(admin.ModelAdmin):
    readonly_fields = ('family_name', 'given_name', 'organization', 'preset', 'os', 'machine_use', 'need_display', 'need_mouse', 'need_keyboard', 'need_ethernet', 'extra_information')
    fields = ('email', 'requester_type', 'faculty_and_dept', 'amount', 'filled')
    list_display = ('family_name', 'given_name', 'preset', 'os', 'need_display', 'need_mouse', 'need_keyboard', 'need_ethernet', 'amount', 'filled')
